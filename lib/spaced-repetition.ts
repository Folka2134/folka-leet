 ...
 */
export function calculateNextReviewDate(difficultyRating: DifficultyRating, reviewCount: number): Date {
  ...
  const intervalMultiplier = reviewCount === 0 ? 1 : Math.pow(2, reviewCount - 1)
